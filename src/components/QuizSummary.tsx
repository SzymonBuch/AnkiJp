  ...
  return (
    <div className="flex flex-col gap-6 py-8">
      <div className="text-center">
        ...
        <div className="mx-auto mt-4 flex w-36 flex-col items-center rounded-2xl border border-slate-200 bg-white py-6 shadow-sm">
            ...
            {mistakes.map((answer) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm text-slate-500">{answer.question.prompt}</div>
                    <div className="font-medium text-green-700">✓ {answer.question.correct}</div>
                    <div className="text-red-600">✗ {answer.selected}</div>
                  </div>
                </div>
              </li>
            ))}
      ...
      <div className="flex gap-3">
        <button
          type="button"
          onClick={onRetake}
          className="flex-1 rounded-xl border border-slate-300 bg-white px-6 py-3 font-semibold text-slate-700 shadow-sm transition active:scale-95"
        >
          Retake
        </button>
        <button
          type="button"
          onClick={onExit}
          className="flex-1 rounded-xl bg-slate-800 px-6 py-3 font-semibold text-white shadow-md transition active:scale-95"
        >
          Done
        </button>
      </div>
